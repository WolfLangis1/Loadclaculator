...
export const LOAD_TEMPLATES = {
  general: [
    ...
    { id: 5, name: 'Garbage Disposal', quantity: 0, amps: 8, volts: 120, va: 960, total: 0, category: 'kitchen' as const, critical: false, circuit: '' },
    { id: 6, name: 'Electric Clothes Dryer', quantity: 0, amps: 30, volts: 240, va: 7200, total: 0, category: 'laundry' as const, critical: false, circuit: '' },
